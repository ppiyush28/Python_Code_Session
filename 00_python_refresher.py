...
days_of_the_week[:5]
days_of_the_week[1:5]  # the third element means every second element
days_of_the_week.insert(2,"append")
##### CONDITIONALS ######
...
sinan = {
 "age" : 23, "location" : "Baltimore" ,"gender": "Male", "occupation": "Professor/Entrepreneur"}
...
for person in people:
    print (type(person))
    if (type(person["location"] == str)):
        print (person['age'],  " and lives in "+person['location'])
    else:
        print (person['age'],  " and lives in "+person['location'][1])
    counter = counter +1
...
[y / 2 for y in flubber] #note the 2.0 instead of 2
...
def give_me_five(x ,y,z = 4):
    x = x / 2 
    print("x  is ", x)
    print ("y is ", y)
    print("z is ", z)        # function definition ends with colon
...
point_1 = (1, 2, 2,5)   #tuples have a paranthesis
point_2  = ("a",  5)
point_3  = ("b", 7, 7)
